...
from agent.strategy import ParentStrategy, OneMoveStrategy2, TwoMoveStrategy, RandomStrategy, ThreeMoveStrategy
...
class Agent:
    ...
    def __init__(self, color: PlayerColor, **referee: dict):
        ...
        self.strategy = ThreeMoveStrategy(color, **referee)
