...
from agent.strategy import ParentStrategy, OneMoveStrategy2, TwoMoveStrategy, RandomStrategy, MonteCarloStrategy
...
class Agent:
    ...
    def __init__(self, color: PlayerColor, **referee: dict):
        ...
        self.strategy = MonteCarloStrategy(color, **referee)
